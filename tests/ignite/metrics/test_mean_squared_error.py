...
def _test_distrib_accumulator_device(device):
    ...
    for metric_device in metric_devices:
        ...
        assert mse._sum_of_squared_errors.device == metric_device, f"{type(mse._sum_of_squared_errors.device)}:{mse._sum_of_squared_errors.device} vs {type(metric_device)}:{metric_device}"
